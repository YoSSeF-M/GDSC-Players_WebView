...
import com.yquery.gdsc_players_webview.databinding.ActivityVideoPlayerBinding
import java.io.File
...
//            MediaItem.fromUri("https://storage.googleapis.com/exoplayer-test-media-0/play.mp3")
            MediaItem.fromUri(Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + File.pathSeparator + File.separator + File.separator + this.packageName + File.separator + R.raw.video))
